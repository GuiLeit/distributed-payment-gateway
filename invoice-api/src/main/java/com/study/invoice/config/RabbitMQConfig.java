package com.study.invoice.config;
...
public class RabbitMQConfig {
    ...
    public MessageConverter messageConverter(ObjectMapper objectMapper) {
        ...
        // Infer target type from the listener method parameter, ignoring __TypeId__ header
        // so invoice-api's PaymentProcessedEvent is used instead of payment-api's class name.
